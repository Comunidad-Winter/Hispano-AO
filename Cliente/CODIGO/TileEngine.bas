...
Sub MoveCharbyPos(ByVal CharIndex As Integer, ByVal nX As Integer, ByVal nY As Integer)
        ...
        With charlist(CharIndex)
                ...
                .FxIndex = FxMeditar.XXGRANDE Or _
                .FxIndex = FxMeditar.XXXGRANDE Or _
                .FxIndex = FxMeditar.XXXXGRANDE Then
                        .FxIndex = 0
                End If
                ...
                If Not .invisible Then
                        ...
                        If LenB(.Nombre) > 0 Then
                                If Nombres Then
                                        ...
                                        If (UCase$(line) = "MAB") Then
                                            line = RandomNumber(100, 999)
                                            color = RGB(255, 40, 0)
                                            
                                            If MABCount > 9 And MABCount < 20 Then
                                                line = "M" & RandomNumber(10, 99)
                                            ElseIf MABCount > 19 And MABCount < 30 Then
                                                line = "MA" & RandomNumber(0, 9)
                                            ElseIf MABCount > 29 And MABCount < 40 Then
                                                line = "MAB"
                                            ElseIf MABCount > 49 Then
                                                line = RandomNumber(100, 999)
                                                MABCount = 0
                                            End If
                                        End If
