...
Private Sub imgMay_Click()
        ...
        'Call Audio.PlayWave(SND_CLICK)
        Me.Picture = MinMayBack(e_modo_keypad.MAYUSCULA)  'LoadPicture(Dirinterfaces & "KeyPadMay.bmp")
        Modo = MAYUSCULA
        Me.txtPassword.SetFocus
...
Private Sub imgMin_Click()
        ...
        'Call Audio.PlayWave(SND_CLICK)
        Me.Picture = MinMayBack(e_modo_keypad.MINUSCULA) 'LoadPicture(Dirinterfaces & "KeyPadMin.bmp")
        Modo = MINUSCULA
        Me.txtPassword.SetFocus
