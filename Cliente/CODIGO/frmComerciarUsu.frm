...
Private Sub LoadButtons()
        ...
        Call cBotonAceptar.Initialize(imgAceptar, GrhPath & "BotonAceptarComUsu.jpg", vbNullString, GrhPath & "BotonAceptarClickComUsu.jpg", Me, , True)
                                    
        Call cBotonConfirmar.Initialize(imgConfirmar, GrhPath & "BotonConfirmarComUsu.jpg", vbNullString, GrhPath & "BotonConfirmarClickComUsu.jpg", Me, , True)
                                        
        Call cBotonRechazar.Initialize(imgRechazar, GrhPath & "BotonRechazarComUsu.jpg", vbNullString, GrhPath & "BotonRechazarClickComUsu.jpg", Me, , True)
                                        
        Call cBotonCancelar.Initialize(imgCancelar, GrhPath & "BotonCancelarComUsu.jpg", vbNullString, GrhPath & "BotonCancelarClickComUsu.jpg", Me)
