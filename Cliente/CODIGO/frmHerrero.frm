...
Private Sub CargarImagenes()
        ...
        Call cPicCerrar.Initialize(imgCerrar, ImgPath & "BotonCerrarHerreria.jpg", ImgPath & "BotonCerrarHerreria.jpg", ImgPath & "BotonCerrarClickHerreria.jpg", Me)
        Call cPicConstruir(0).Initialize(picConstruir0, ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirClickHerreria.jpg", Me)
        Call cPicConstruir(1).Initialize(picConstruir1, ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirClickHerreria.jpg", Me)
        Call cPicConstruir(2).Initialize(picConstruir2, ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirClickHerreria.jpg", Me)
        Call cPicConstruir(3).Initialize(picConstruir3, ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirHerreria.jpg", ImgPath & "BotonConstruirClickHerreria.jpg", Me)
        Call cPicMejorar(0).Initialize(picMejorar0, ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarClickHerreria.jpg", Me)
        Call cPicMejorar(1).Initialize(picMejorar1, ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarClickHerreria.jpg", Me)
        Call cPicMejorar(2).Initialize(picMejorar2, ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarClickHerreria.jpg", Me)
        Call cPicMejorar(3).Initialize(picMejorar3, ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarHerreria.jpg", ImgPath & "BotonMejorarClickHerreria.jpg", Me)
