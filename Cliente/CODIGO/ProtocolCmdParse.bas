...
Public Sub ParseUserCommand(ByVal RawCommand As String)
        ...
        If Left$(Comando, 1) = "/" Then
                ...
                Select Case Comando
                        ...
                        Case "/GM"
                            If frmGM.Visible = False Then
                                Call frmGM.Show(vbModeless, frmMain)
                            End If
                        ...
                        Case "/DENUNCIAR"
                                ...
                                Else
                                        ...
                                        Call ShowConsoleMsg("Faltan " & CStr(MainTimer.GetTickInterval(TimersIndex.SendDenunce)) & " segundos para que pueda enviar otra denuncia, por favor espere.")
                        ...
                        Case "/FUNDARCLAN"
                                ...
                                Else
                                        Call ShowConsoleMsg("No posees el nivel suficiente para utilizar dicha función.")
                                End If
                        ...
                        Case "/RACC"
                                ...
                                If notNullArguments And CantidadArgumentos >= 2 Then
                                        If ValidNumber(ArgumentosAll(0), eNumber_Types.ent_Integer) And ValidNumber(ArgumentosAll(1), eNumber_Types.ent_Integer) Then
                                                Call WriteCreateNPCWithRespawn(ArgumentosAll(0), ArgumentosAll(1))
                                        Else
                                                'No es numerico
                                                Call ShowConsoleMsg("Npc incorrecto. Utilice /racc NPC CANTIDAD.")

                                        End If

                                Else
                                        'Avisar que falta el parametro
                                        Call ShowConsoleMsg("Faltan parámetros. Utilice /racc NPC CANTIDAD.")
                        ...
                        Case "/CREARPRETORIANOS"
                                ...
                                Call WriteCreatePretorianClan
                
                        Case "/ELIMINARPRETORIANOS"
            
                                Call WriteDeletePretorianClan
                        ...
                        Case "/SOLICITARCSU"
                                ...
                                If notNullArguments Then
                                    Call WriteSolicitarCSU(ArgumentosRaw)
                                Else
                                    Call ShowConsoleMsg("Faltan parametros. Utilice /SOLICITARCSU NICKNAME")
                                End If
                        ...
                        Case "/CAMBIARPJ"
                                ...
                                If notNullArguments Then
                                        ...
                                        If UBound(tmpArr) = 1 Then
                                                Call WriteCambiarPJ(tmpArr(0), tmpArr(1))
                                        Else
                                                'Faltan los parametros con el formato propio
                                                Call ShowConsoleMsg("Formato incorrecto. Utilice /CAMBIARPJ PERSONAJE 1@PERSONAJE 2.")
                                        End If
                                Else
                                        'Avisar que falta el parametro
                                        Call ShowConsoleMsg("Faltan parámetros. Utilice /CAMBIARPJ PERSONAJE 1@PERSONAJE 2.")
                                End If
                                
                        Case "/MASSRMATA"
                                
                                Call WriteKillAllNearbyNPCsWithRespawn
