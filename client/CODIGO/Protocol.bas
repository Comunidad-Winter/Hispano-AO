...
Private Sub HandleUpdateHP()
        ...
        bWidth = (((UserMinHP / 100) / (UserMaxHP / 100)) * 146)
...
Private Sub HandleUpdateUserStats()
        ...
        If UserPasarNivel > 0 Then
                frmMain.ImgExp.Width = (((UserExp / 100) / (UserPasarNivel / 100)) * 110)
        Else
        ...
        frmMain.shpVida.Width = (((UserMinHP / 100) / (UserMaxHP / 100)) * 146)
    
        frmMain.shpEnergia.Width = (((UserMinSTA / 100) / (UserMaxSTA / 100)) * 146)
        '***************************
...
Private Sub HandleUpdateHungerAndThirst()
        ...
        'bWidth = (((UserMinHAM / 100) / (UserMaxHAM / 100)) * 104)
    
        'frmMain.shpHambre.Width = bWidth
        '*********************************
    
        'bWidth = (((UserMinAGU / 100) / (UserMaxAGU / 100)) * 104)
