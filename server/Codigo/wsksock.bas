...
Public Function AddrToIP(ByRef AddrOrIP As String) As String
...
Function ConnectSock(ByVal Host As String, _
                     ByVal Port As Long, _
                     ByRef retIpPort As String, _
                     ByVal HWndToMsg As Long, _
                     ByVal Async As Integer) As Long
        ...
        If Not Async Then
                ...
                If HWndToMsg <> 0 Then
                        ...
                        If WSAAsyncSelect(s, HWndToMsg, ByVal WM_WINSOCK, ByVal SelectOps) Then
                                If s > 0 Then
                                        dummy = apiclosesocket(s)
...
Public Function SetSockLinger(ByVal SockNum As Long, _
                              ByVal OnOff As Integer, _
                              ByVal LingerTime As Integer) As Long
...
Sub EndWinsock()
        ...
        Call WSApiCloseSocket(SockListen, 0)
        ret = WSACleanup()
        WSAStartedUp = False
...
Public Function GetHostByNameAlias(ByRef HostName As String) As Long
...
Public Function GetPeerAddress(ByVal s As Long) As String
...
Public Function GetPortFromString(ByVal PortStr As String) As Long
...
Function GetProtocolByName(ByRef Protocol As String) As Long

        Dim tmpShort   As Long
...
Function GetServiceByName(ByRef service As String, ByRef Protocol As String) As Long
...
Function GetSockAddress(ByVal s As Long) As String
...
Function IpToAddr(ByRef AddrOrIP As String) As String
...
Public Function GetLongIp(ByRef IPS As String) As Long
...
Public Function ListenForConnect(ByVal Port As Long, _
                                 ByVal HWndToMsg As Long, _
                                 ByVal Enlazar As String) As Long
        ...
        If WSAAsyncSelect(s, HWndToMsg, ByVal WM_WINSOCK, ByVal FD_ACCEPT) Then
                If s > 0 Then
                        dummy = apiclosesocket(s)
...
Public Function kSendData(ByVal s As Long, ByRef vMessage As Variant) As Long
...
Public Function WSAMakeSelectReply(ByVal TheEvent As Integer, _
                                   ByVal TheError As Integer) As Long
