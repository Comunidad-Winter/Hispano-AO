...
Public Sub Comercio(ByVal Modo As eModoComercio, _
        ...
        If Modo = eModoComercio.Compra Then
                If Slot > MAX_NORMAL_INVENTORY_SLOTS Then
                        Exit Sub
        ...
        ElseIf Modo = eModoComercio.Venta Then
                ...
                If NpcSlot <= MAX_NORMAL_INVENTORY_SLOTS Then 'Slot valido
                ...
                'Es un Objeto que tenemos que loguear?
                If ObjData(Objeto.objIndex).Log = 1 Then
                        Call LogItemsEspeciales(UserList(UserIndex).Name & " vendió al NPC " & Objeto.Amount & " " & ObjData(Objeto.objIndex).Name)
                ElseIf Objeto.Amount >= 1000 Then 'Es mucha cantidad?
