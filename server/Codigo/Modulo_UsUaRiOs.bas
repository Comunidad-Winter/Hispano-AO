        ...
        With UserList(UserIndex)
                ...
                Do While .Stats.Exp >= .Stats.ELU
                        ...
                        If EsNewbie(UserIndex) Then
                                ...
                                Call WriteConsoleMsg(UserIndex, "Has ganado " & tmpOro & " monedas de oro, por subir de nivel mientras esas newbie", FontTypeNames.FONTTYPE_INFO)
                                Call WriteConsoleMsg(UserIndex, "Recuerda!! Si no te gusta el promedio de vida que tiene tu personaje puedes utilizar el comando /RESET, para volver a nivel 1, mientras seas un Newbie", FontTypeNames.FONTTYPE_INFO)
                        End If
