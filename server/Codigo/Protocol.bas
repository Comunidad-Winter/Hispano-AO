...
Private Sub HandleLoginExistingChar(ByVal UserIndex As Integer)
        ...
        #If SeguridadAlkon Then
                ...
                If BANCheck(UserName) Then
                        Call WriteErrorMsg(UserIndex, "Se te ha prohibido la entrada a Hispano Online debido a tu mal comportamiento. Puedes consultar el reglamento y el sistema de soporte desde www.hispano-ao.com")
