...
Public Function m_EsGuildLeader(ByRef PJ As String, _
                                 ByVal GuildIndex As Integer) As Boolean
        '***************************************************
        'Author: Unknown
        'Last Modification: -
...
Public Function m_EsGuildFounder(ByRef PJ As String, _
                                  ByVal GuildIndex As Integer) As Boolean
        '***************************************************
        'Author: Unknown
        'Last Modification: -
...
Public Function CrearNuevoClan(ByVal FundadorIndex As Integer, _
        ...
        If CANTIDADDECLANES < UBound(guilds) Then
                ...
                UserList(FundadorIndex).Stats.GLD = UserList(FundadorIndex).Stats.GLD - 1500000
...
Public Function PuedeFundarUnClan(ByVal UserIndex As Integer, _
        ...
        If UserList(UserIndex).Stats.ELV < 32 Or UserList(UserIndex).Stats.UserSkills(eSkill.Liderazgo) < 90 Or UserList(UserIndex).Stats.GLD < 1500000 Then
                refError = "Para fundar un clan debes ser nivel 32, tener 90 skills en liderazgo y poseer 1.500.000 monedas de oro."
                Exit Function
