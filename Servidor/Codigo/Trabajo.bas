...
Public Sub DoPescar(ByVal UserIndex As Integer)
        ...
        Dim i As Long
        Dim EstaDentroDeZona As Boolean
        Dim Place As Byte
        ...
        With UserList(UserIndex)
                ...
                If res <= 6 Then
                        ...
                        If PescaEvent.Activado = 1 Then
                            For i = 1 To PescaEvent.CantidadDeZonas
                                If UserList(UserIndex).Pos.Map = Zona(i).mapa Then
                                    MiObj.objIndex = modPesca.DamePez(i)
                                    
                                    If .clase = eClass.Worker Then
                                        MiObj.Amount = RandomNumber(MinPez, MaxPez)
                                    Else
                        ...
                        Call WriteConsoleMsg(UserIndex, "¡Has pescado: " & ObjData(MiObj.objIndex).Name & "!", FontTypeNames.FONTTYPE_INFO)
