...
Public Sub CargarConfiguracionHAO()
        ...
        If Configuracion.MapNoLimpiezaCant > 0 Then
...
Sub LoadUserInit(ByVal UserIndex As Integer, ByRef UserFile As clsIniManager)
        ...
        With UserList(UserIndex)
                ...
                With .flags
                        ...
                        .LastCiudMatado = CStr(UserFile.GetValue("ANTIFRAGUEO", "IPUltimoCiudaMatado"))
                        .LastCrimMatado = CStr(UserFile.GetValue("ANTIFRAGUEO", "IPUltimoCrimiMatado"))
                        
                        .GMConsulta = CStr(UserFile.GetValue("CONSULTAS", "GMConsulta"))
                        .GMRespuesta = CStr(UserFile.GetValue("CONSULTAS", "GMRespuesta"))
                        
                        .GanadorTorneoDeClanes = CStr(UserFile.GetValue("INIT", "GanadorTorneoDeClanes"))
                        
                        .RecibioPerdonFaccionario = CStr(UserFile.GetValue("INIT", "RecibioPerdonFaccionario"))
...
Sub SaveUser(ByVal UserIndex As Integer, _
        ...
        With UserList(UserIndex)
                ...
                Call Manager.ChangeValue("CONSULTAS", "GMConsulta", CStr(.flags.GMConsulta))
                Call Manager.ChangeValue("CONSULTAS", "GMRespuesta", CStr(.flags.GMRespuesta))
                
                Call Manager.ChangeValue("ANTIFRAGUEO", "IPUltimoCiudaMatado", CStr(.flags.LastCiudMatado))
                Call Manager.ChangeValue("ANTIFRAGUEO", "IPUltimoCrimiMatado", CStr(.flags.LastCrimMatado))
                
                Call Manager.ChangeValue("INIT", "GanadorTorneoDeClanes", CStr(.flags.GanadorTorneoDeClanes))
                
                Call Manager.ChangeValue("INIT", "RecibioPerdonFaccionario", CStr(.flags.RecibioPerdonFaccionario))
