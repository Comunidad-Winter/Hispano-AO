...
Public Sub CheckUserLevel(ByVal UserIndex As Integer)
        ...
        With UserList(UserIndex)
                ...
                Do While .Stats.Exp >= .Stats.ELU
                        ...
                        '// MAB - Última actualización: 24/06/2017
                        '// Detalles: Se colocaron los valores por default de la 13.0
                        ...
                        Select Case .clase
                                ...
                                Case eClass.Worker
                                        ...
                                        Select Case .Stats.UserAtributos(Constitucion)
                                                ...
                                                Case Else
                                                        AumentoHP = RandomNumber(6, .Stats.UserAtributos(Constitucion) \ 2) + AdicionalHPGuerrero
                                ...
                                Case eClass.Cleric
                                        ...
                                        Select Case .Stats.UserAtributos(eAtributos.Constitucion)
                                                ...
                                                Case Else
                                                        AumentoHP = RandomNumber(5, .Stats.UserAtributos(Constitucion) \ 2)
                                ...
                                Case Else
                                        ...
                                        Select Case .Stats.UserAtributos(eAtributos.Constitucion)
                                                ...
                                                Case Else
                                                        AumentoHP = RandomNumber(5, .Stats.UserAtributos(eAtributos.Constitucion) \ 2)

                                        End Select
                              
                                        ' @@ Miqueas : Minimo Que tira de Vida 6.
                                        If AumentoHP <= 4 Then AumentoHP = 4
                        ...
                        If EsNewbie(UserIndex) Then
                                Call WriteConsoleMsg(UserIndex, "Recuerda que si no te gusta el promedio de vida que tiene tu personaje puedes utilizar el comando /RESET para volver a nivel 1 mientras seas newbie.", FontTypeNames.FONTTYPE_INFO)
                        End If
...
Public Sub SendUserStatsTxt(ByVal sendIndex As Integer, ByVal UserIndex As Integer)
        ...
        With UserList(UserIndex)
                ...
                If .Invent.ArmourEqpObjIndex > 0 Then
                        If .Invent.FactionArmourEqpObjIndex > 0 Then ModificadorDefensa = MOD_DEF_SEG_JERARQUIA Else ModificadorDefensa = 1
...
Public Sub ContarMuerte(ByVal Muerto As Integer, ByVal Atacante As Integer)
        ...
        '22/06/2017: MAB - Alkon tira la idea y nunca la desarrolla, que raro... ahora sí, no se puede truchar más frags.
        '********************************************************************************
        ...
        With UserList(Atacante)
                ...
                If criminal(Muerto) Then
                        If .flags.LastCrimMatado <> UserList(Muerto).Ip Then 'Porque carajo comprobarías el nombre si podes hacerlo con la IP!
                                .flags.LastCrimMatado = UserList(Muerto).Ip
                                
                                Call Manager.ChangeValue("ANTIFRAGUEO", "IPUltimoCrimiMatado", UserList(Muerto).Ip)
                ...
                Else
                        ...
                        If .flags.LastCiudMatado <> UserList(Muerto).Ip Then 'Porque carajo comprobarías el nombre si podes hacerlo con la IP!
                                .flags.LastCiudMatado = UserList(Muerto).Ip
                                
                                Call Manager.ChangeValue("ANTIFRAGUEO", "IPUltimoCiudaMatado", UserList(Muerto).Ip)
