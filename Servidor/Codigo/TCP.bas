...
Sub ConnectNewUser(ByVal UserIndex As Integer, _
        ...
        With UserList(UserIndex)
                ...
                .flags.RecibioPerdonFaccionario = 0
        ...
        Call WriteVar(CharPath & UCase$(Name) & ".chr", "INIT", "SecurityCode", SecurityCode)
...
Sub ConnectUser(ByVal UserIndex As Integer, _
        ...
        With UserList(UserIndex)
                ...
                If Not LenB(.flags.GMRespuesta) = 0 Then
                    WriteReceiveRespuestaConsulta (UserIndex)
                End If
                            
                If Not LenB(.flags.GMConsulta) = 0 And LenB(.flags.GMRespuesta) = 0 Then
...
Sub ResetUserFlags(ByVal UserIndex As Integer)
        ...
        With UserList(UserIndex).flags
                ...
                .GMConsulta = vbNullString
                .GMRespuesta = vbNullString
