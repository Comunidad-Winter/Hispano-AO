...
Public Enum FXIDs
        ...
        FXMEDITARXXXGRANDE = 34
        FXMEDITARXXXXGRANDE = 37
...
Public Const NUM_PECES            As Integer = 9
...
Public Type UserFlags
        ...
        GMConsulta As String
        GMRespuesta As String
        
        GanadorTorneoDeClanes As Byte
        
        RecibioPerdonFaccionario As Byte
