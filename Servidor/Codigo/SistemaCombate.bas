...
Public Sub UserDañoNpc(ByVal UserIndex As Integer, ByVal NpcIndex As Integer)
        ...
        With Npclist(NpcIndex)
                ...
                'Call CheckPets(NpcIndex, UserIndex, False) 'Elementales atacan a distancia
...
Sub CalcularDarExp(ByVal UserIndex As Integer, ByVal NpcIndex As Integer, ByVal ElDaño As Long)
        ...
        If ExpaDar > 0 Then
                ...
                Else
                        ...
                        Call WriteConsoleMsg(UserIndex, "Has ganado " & IIf(ExpaDar > 999, FormatNumber(ExpaDar, 0, vbFalse, vbFalse, vbTrue), ExpaDar) & " puntos de experiencia.", FontTypeNames.FONTTYPE_FIGHT)
