...
Private Sub AutoSave_Timer()
        ...
        Select Case Minutos
                ...
                Case MinutosWs - 1
                        Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> Se guardará el mundo en 1 minuto...", FontTypeNames.FONTTYPE_SERVER))
        ...
        Select Case MinsPjesSave
                ...
                Case MinutosGuardarUsuarios - 1
                        Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> Se guardarán los personajes en 1 minuto...", FontTypeNames.FONTTYPE_SERVER))
        ...
        Select Case MinutosLatsClean
                ...
                Case 14
                        Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> Se limpiará el mundo en 1 minuto...", FontTypeNames.FONTTYPE_SERVER))
        ...
        Select Case MinsEventoPesca
            Case Is >= PescaEvent.Tiempo
                With PescaEvent
                    If .Activado = 0 Then
                        .Activado = 1
                        MinsEventoPesca = 0
