...
Sub WorldSave()
        ...
        Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> Iniciando guardado del mundo...", FontTypeNames.FONTTYPE_SERVER))
        ...
        Call SendData(SendTarget.ToAll, 0, PrepareMessageConsoleMsg("Servidor> Guardado del mundo finalizado.", FontTypeNames.FONTTYPE_SERVER))
...
Public Sub PurgarPenas()
        ...
        '***************************************************
        ' @@ Todo
        ' @@ Esto tendria que estar en el sub pasarsegundo ...
        Dim i As Long
